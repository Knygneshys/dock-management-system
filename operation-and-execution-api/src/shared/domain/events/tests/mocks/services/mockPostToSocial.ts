...
export class MockPostToSocial implements IHandle<MockJobCreatedEvent>, IHandle<MockJobDeletedEvent> {
  ...
  setupSubscriptions(): void {
    DomainEvents.register(this.handleJobCreatedEvent as any, MockJobCreatedEvent.name);
    DomainEvents.register(this.handleDeletedEvent as any, MockJobDeletedEvent.name);
  }
