...
{
    /// <inheritdoc />
    public partial class InitialCreation_Sqlite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CargoManifestId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    QualificationsId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    QualificationsId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StaffMembersId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Size3D_Height = table.Column<float>(type: "REAL", nullable: false),
                    Size3D_Depth = table.Column<float>(type: "REAL", nullable: false),
                    StorageAreaId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableUntil = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AllowedVesselTypesId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DocksId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Code = table.Column<string>(type: "TEXT", nullable: false),
                    DockRecordId = table.Column<Guid>(type: "TEXT", nullable: false),
                    StorageAreaId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAgentRepresentativeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    FeedBackId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CargoLoadManifestId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CargoUnloadManifestId = table.Column<Guid>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VesselVisitNotifications_CargoManifests_CargoUnloadManifestId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_VesselVisitNotifications_ShippingAgentRepresentatives_ShippingAgentRepresentativeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CrewManifestId = table.Column<Guid>(type: "TEXT", nullable: false),
                    inVesselVisitsId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CrewMemberVesselVisitNotification_VesselVisitNotifications_inVesselVisitsId",
